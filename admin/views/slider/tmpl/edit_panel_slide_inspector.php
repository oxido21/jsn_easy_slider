		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane form-horizontal" id="thumb-setting-image">
                ...
                <div class="row" data-bind="visible:background.kenburn.enable">
                    ...
                    <strong class="col-xs-4 center">Start</strong>
                    <strong class="col-xs-4 center">End</strong>
                </div> <!-- row end -->
                <div class="row" data-bind="visible:background.kenburn.enable">
                    <label class="col-xs-3">Pos X</label>
                    <div class="col-xs-4" >
                        <input type="number" class="form-control input-xs" data-bind="background.kenburn.from.x">
                    </div>
                    <div class="col-xs-4" >
                        <input type="number" class="form-control input-xs" data-bind="background.kenburn.to.x">
                    </div>
                </div> <!-- row end -->
                <div class="row" data-bind="visible:background.kenburn.enable">
                    <label class="col-xs-3">Pos Y</label>
                    <div class="col-xs-4" >
                        <input type="number" class="form-control input-xs" data-bind="background.kenburn.from.y">
                    </div>
                    <div class="col-xs-4" >
                        <input type="number" class="form-control input-xs" data-bind="background.kenburn.to.y">
                    </div>
                </div> <!-- row end -->
                <div class="row" data-bind="visible:background.kenburn.enable">
                    <label class="col-xs-3">Zoom</label>
                    <div class="col-xs-4">
                        <input type="number" step="0.1" class="form-control input-xs" data-bind="background.kenburn.from.scale">
                    </div>
                    <div class="col-xs-4">
                        <input type="number" step="0.1" class="form-control input-xs" data-bind="background.kenburn.to.scale">
                    </div>
                </div> <!-- row end -->
				<hr>
				<div class="row" >
